...
async def test_unexpected_response_content(mock_resource):
...
async def test_error_full(mock_resource, mock_error):
...
async def test_error_message_only(mock_resource, mock_error):
    """HTTP error response with null detail should work"""
