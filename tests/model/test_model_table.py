...
async def test_model_table_schema_meta_valid(mock_model):
...
async def test_model_table_schema_meta_invalid(mock_model):
...
async def test_model_table_schema_invalid_type(mock_model):
