...
the built-in `snow.schemas` package is the speedy route. It contains Resource :class:`~snow.resource.schema.Schema`
type classes modelled after the ServiceNow table defaults, and can be used either directly or tailored to your needs.

More Schemas will be added on an ongoing basis.
